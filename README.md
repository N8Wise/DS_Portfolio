...
Summary: A recommendation system using document similarity.<br/>  
**Code: Python (Jupyter Notebook)**
...
Summary: An exploratory analysis of life expectancy and GDP using the gapminder dataset.<br/>  
**Code: R (RStudio)**
